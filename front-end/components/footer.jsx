    ...
    return (
        <>
            <div className="flex flex-col bg-[#02A95C] h-[60vh] rounded-t-[15px] justify-evenly ">
                <div className="flex">
                <div className="w-[30%] flex flex-col h-[50%] justify-center"><h1 className=" text-center text-7xl font-bold text-white ">MyFin</h1></div>
                <div className=" flex h-[70%] w-[60%] justify-between mt-[5%]">
