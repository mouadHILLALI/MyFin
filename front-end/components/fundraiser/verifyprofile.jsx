...
export const VerifyProfile = () => {
  ...
  return (
    <>
        ...
        <form onSubmit={handleform} className=" m-auto h-[40%] md:h-[60%] bg-white drop-shadow-lg p-2 flex flex-col items-center justify-center w-[80%] md:w-[60%] flex flex-col gap-3">
